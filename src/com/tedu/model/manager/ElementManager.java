...
//	初始化
	protected void init(){
		...
		map.put("purpleGhost", new ArrayList<>());
		map.put("redGhost", new ArrayList<>());
		map.put("teleControl", new ArrayList<>());
		map.put("mine", new ArrayList<>());
		map.put("superCard", new ArrayList<>());
	}
//	得到一个完整的 map集合
